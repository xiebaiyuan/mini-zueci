...
/*
 * To create tests/test_sjis_tab.h (from the project root directory):
 *
 *   php tests/tools/gen_test_tab_h.php
 *
 * To create tests/test_gb2312_tab.h;
 *
 *   php tests/tools/gen_test_tab_h.php -f GB2312.TXT -s gb2312_tab
 *
 * To create tests/test_gbk.h;
 *
 *   php tests/tools/gen_test_tab_h.php -f CP936.TXT -s gbk_tab
 *
 * To create tests/test_gb18030_tab.h (note that tests/tools/data/GB18030.TXT
 ...
 *
 *   php tests/tools/gen_test_tab_h.php -f GB18030.TXT -s gb18030_tab
 *
 * To create tests/test_big5_tab.h;
 *
 *   php tests/tools/gen_test_tab_h.php -f BIG5.TXT -s big5_tab
 *
 * To create tests/test_ksx1001_tab.h;
 *
 *   php tests/tools/gen_test_tab_h.php -f KSX1001.TXT -s ksx1001_tab
 *
 */
...
$out[] = 'static const zueci_u32 test_' . $suffix_name . '[] = {';
$out = array_merge($out, $tab_lines);
$out[] = '};';

$out[] = '';
$out[] = 'static const zueci_u32 test_' . $suffix_name . '_ind[] = {';
$first = 0;
